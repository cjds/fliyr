...
<script type="text/javascript" src="<%URL::asset('js/foundation/foundation.js')%>"></script>
<script type="text/javascript" src="<%URL::asset('js/foundation/foundation.topbar.js')%>"></script>
