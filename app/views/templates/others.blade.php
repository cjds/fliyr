<script id="aboutus-template" type="text/x-handlebars-template">
	...
	<div class="large-8  small-12 columns aboutus" >
	
<dl class="accordion" data-accordion>

<dt><a href="#">What is Fliyr?</a></dt>
...
<dt><a href="#">What am I signing up for?</a></dt>
...
<dt><a href="#">How did you come up with the name Fliyr?</a></dt>
...
<dt><a href="#">Who is behind Fliyr?</a></dt>
<dd>
...
<br>
<a href="http://fliyr.com" class="button light-green-button" style=";text-transform:uppercase;"> sign up</a>	
